...
#pragma endregion
	...
	void LoadShader()
	{
		...
		FadeShader->Create(eShaderStage::VS, L"UserInterfaceVS.hlsl", "main");
		FadeShader->Create(eShaderStage::PS, L"UserInterfacePS.hlsl", "main");
	...
	void LoadTexture()
	{
		...
		Resources::Load<Texture>(L"FadeInOutSrite", L"FadeInOut.png");
	}
	...
	void LoadMaterial()
	{
		...
		std::shared_ptr <Texture> FadeInOutSrite = Resources::Find<Texture>(L"FadeInOutSrite");
		std::shared_ptr<Shader> FadeShader = Resources::Find<Shader>(L"FadeShader");
		...
		FadeMaterial->SetTexture(FadeInOutSrite);
